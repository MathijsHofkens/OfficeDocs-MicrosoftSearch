...
To monitor errors, go to **Agents and connectors** > **Active Connector**. Any existing crawl errors are displayed under **Current Crawl** > **Errors**. This section provides:
