...
If you see forbidden or unauthorized response in connection status, check if the service account has required access to the tables mentioned in [Prerequisites](./servicenow-catalog-connector.md#prerequisites). Check whether all the columns in the tables have read access.
