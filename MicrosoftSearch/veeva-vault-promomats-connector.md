...
5. Link user with the security policy.
   ...
   2. Select a user — ideally the vault owner, but otherwise anyone with permission to run VQL queries, use the RESTful API, export documents to file staging, download them from file staging, and have access to the Doclifecycle configuration detail.
   3. Click **Edit**.
